...
public class HomePageObject extends BasePage {
	...
	public boolean isFileLinkUpLoadedByName(String fileName) {
		waitForElementVisible(driver, HomePageUI.FILE_NAME_UPLOAED_LINK, fileName);
		
		return isElementDisplayed(driver, HomePageUI.FILE_NAME_UPLOAED_LINK, fileName);
	}
	...
	public boolean isFileImageUpLoadedByName(String fileName) {
		waitForElementVisible(driver, HomePageUI.FILE_NAME_UPLOAED_IMAGE, fileName);
		
		return isImageLoaded(driver, HomePageUI.FILE_NAME_UPLOAED_IMAGE, fileName);
	}
